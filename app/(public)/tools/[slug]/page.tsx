        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              ...
              <Badge variant="outline" className="capitalize">{tool.pricing}</Badge>
              {tool.is_open_source && <Badge variant="outline">Open Source</Badge>}
            </div>
          </div>
        </div>
        <p className="mt-6 text-lg text-muted-foreground">{tool.description}</p>
        {tool.pricing_details && (
          <p className="mt-2 text-sm text-muted-foreground">Pricing: {tool.pricing_details}</p>
        )}
