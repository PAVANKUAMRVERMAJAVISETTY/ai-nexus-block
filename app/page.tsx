    ...
    <PublicShell>
      <AdminWrapper entityType="profile">
        <div className="relative overflow-hidden bg-background">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              >
                ...
                <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-2">
                  ...
                  <AdminEditButton
                    entityType="profile"
                    item={{ title: profileData.name, description: profileData.bio, image_url: profileData.photo_url }}
                  />
                </div>
              </motion.div>
            </div>

            {/* Framer Motion Competencies Section */}
            <motion.div
              initial={{ opacity: 0, scale: 0.95 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 0.8, delay: 0.2 }}
              className="mt-16 rounded-2xl border border-border/60 bg-card/60 p-6 sm:p-8 backdrop-blur-md shadow-xl"
            >
          ...
          {/* 6-Card Infographic Gateway Grid */}
